...
# Database: z_pe
# Generation Time: 2021-07-13 02:36:40 +0000
# ************************************************************
...
INSERT INTO `sql_tasks` (`id`, `from_app`, `from_db`, `static_rule`, `params`, `to_db_type`, `to_app`, `to_db`, `to_table`, `online_status`, `write_mode`, `task_desc`, `is_truncate`, `owner`, `create_time`, `task_status`, `update_time`)
VALUES
	(1,'local_dw','z_pe','select $start as start,$end as end,num\nfrom (\n	select count(1) as num\n	from $table \n        where $pk>$start and $pk<=$end \n) as a\n','{\"split\":{\"table\":\"test.userinfo\",\"pk\":\"id\",\"worker_num\":20,\"read_batch\":500,\"write_batch\":300}}','mysql','local_dw','z_pe','temp_static',0,'insert','统计',0,'18811788263','2021-03-30 16:13:34','executed_success','2021-07-13 10:36:29');
